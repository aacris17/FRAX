...
Height <- Fracture_Dates[5]
Percent_w/_HT <- (sum(complete.cases(Fracture_Dates$HT.in))/nrow(Fracture_Dates))*100
Percent_w/_WT <- (sum(complete.cases(Fracture_Dates$WT.in))/nrow(Fracture_Dates))*100
(sum(complete.cases(Fracture_Dates$Og_RACE))/nrow(Fracture_Dates))*100
(sum(complete.cases(Fracture_Dates$AGE))/nrow(Fracture_Dates))*100
(sum(complete.cases(Fracture_Dates$GENDER))/nrow(Fracture_Dates))*100
