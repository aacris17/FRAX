...
```{r filtering}
#Select the ID of anyone with a fracture diagnosis: ICD9/10 codes- S62 hand, S92, S99 foot, M88 Osteodeformans/Paget's disease of bone, S02 Face/skull, V trauma due to a collision, Y04 assault by bodily force, C79.5 metastatic disease to bone, hip fracture M84.359, M84.459, M84.659, Vertebral: 805|806|733.13|S12|M48.50|M80.08, Humerus (distal and shaft): 812.01|812.23|733.11|S42.2|M84.429A, Forearm: 813.45|813.8|733.12|813.0|S52|M84.429A
...
EM_Dates_ed <- EM_Dates_ed %>% left_join(ID_fracs, by = 'ID')
