...
smooth <- test %>% unite('SEX_Control', c(Control, GENDER), remove = FALSE) %>% unite('DM_Control', c(Control,DM), remove = FALSE) %>% unite('Race_Control', c(Control,Og_RACE), remove =  FALSE) %>% select(ID,SEX_Control,DM_Control,ageatindex,Risk,DM) %>% filter (!is.na(Risk))
